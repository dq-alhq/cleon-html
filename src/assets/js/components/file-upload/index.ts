...
class HSFileUpload extends HSBasePlugin<IFileUploadOptions> implements IFileUpload {
    ...
    constructor(el: HTMLElement, options?: IFileUploadOptions, events?: {}) {
        ...
        this.concatOptions = {
            clickable: this.el.querySelector('[data-hs-file-upload-trigger]') as HTMLElement,
            previewsContainer: this.el.querySelector('[data-hs-file-upload-previews]') as HTMLElement,
    ...
    private initDropzone() {
        const clear = this.el.querySelector('[data-hs-file-upload-clear]') as HTMLButtonElement
    ...
    private onAddFile(file: DropzoneFile) {
        ...
        const reloadButton = file.previewElement.querySelector('[data-hs-file-upload-reload]')
    ...
    private previewAccepted(file: DropzoneFile) {
        ...
        const fileName = previewElement.querySelector('[data-hs-file-upload-file-name]')
        const fileExt = previewElement.querySelector('[data-hs-file-upload-file-ext]')
        const fileSize = previewElement.querySelector('[data-hs-file-upload-file-size]')
        const fileIcon = previewElement.querySelector('[data-hs-file-upload-file-icon]') as HTMLElement
        const trigger = this.el.querySelector('[data-hs-file-upload-trigger]') as HTMLElement
        const preview = previewElement.querySelector('[data-dz-thumbnail]') as HTMLElement
        const remove = previewElement.querySelector('[data-hs-file-upload-remove]') as HTMLButtonElement
    ...
    private onUploadProgress(file: DropzoneFile, progress: number) {
        ...
        const progressBarPane = previewElement.querySelector('[data-hs-file-upload-progress-bar-pane]') as HTMLElement
        const progressBarValue = previewElement.querySelector('[data-hs-file-upload-progress-bar-value]') as HTMLElement
    ...
    static autoInit() {
        ...
        document.querySelectorAll('[data-hs-file-upload]:not(.--prevent-on-load-init)').forEach((el: HTMLElement) => {
...
window.addEventListener('load', () => {
    if (document.querySelectorAll('[data-hs-file-upload]:not(.--prevent-on-load-init)').length) {
        if (typeof _ === 'undefined') console.error('HSFileUpload: Lodash is not available, please add it to the page.')
