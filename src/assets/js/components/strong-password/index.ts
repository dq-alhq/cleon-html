...
class HSStrongPassword extends HSBasePlugin<IStrongPasswordOptions> implements IStrongPassword {
    ...
    private buildHints() {
        this.weakness =
            (this.hints as HTMLElement).querySelector('[data-hs-strong-password-hints-weakness-text]') || null
        this.rules =
            Array.from((this.hints as HTMLElement).querySelectorAll('[data-hs-strong-password-hints-rule-text]')) ||
            null
