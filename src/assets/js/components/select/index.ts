...
class HSSelect extends HSBasePlugin<ISelectOptions> implements ISelect {
    ...
    static autoInit() {
        ...
        document.querySelectorAll('[data-hs-select]:not(.--prevent-on-load-init)').forEach((el: HTMLElement) => {
    ...
    static onArrow(isArrowUp = true) {
        ...
        if (target) {
            ...
            const current =
                dropdown.querySelector('.hs-select-option-highlighted') || dropdown.querySelector('.selected')
