...
class HSAccordion extends HSBasePlugin<IAccordionOptions> implements IAccordion {
    ...
    static autoInit() {
        ...
        document.querySelectorAll('.hs-accordion:not(.--prevent-on-load-init)').forEach((el: HTMLElement) => {
    ...
    static treeView() {
        ...
        document.querySelectorAll('.hs-accordion-treeview-root').forEach((el: HTMLElement) => {
        ...
        if (this.selectable.length)
            this.selectable.forEach((item) => {
                ...
                el.querySelectorAll('.hs-accordion-selectable').forEach((_el: HTMLElement) => {
